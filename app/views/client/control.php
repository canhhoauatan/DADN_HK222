...
<body>
  <div class="db-container">
    <div class="row">
      ...
      <div class="rightBlock col-lg-10 col-sm-11">
        ...
        <div class="content-container">
          ...
          <div class="auto-container">
            ...
            <div class="pie">
              <div class="piece2">
                <img src="resources/img/lamp.png" alt="asdas">
                <p>Đèn</p>
                <label class="switch">
                  <input type="checkbox">
                  <span class="slider round"></span>
              ...
              <div class="piece2">
                <img src="resources/img/water.png" alt="asdas">
                <p>Máy bơm</p>
                <label class="switch">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Máy bơm đang để chế độ tự động. Bạn có muốn tắt nó?</p>
        </div>
        <div class="modal-footer">
          <button id="yes-btn">Có</button>
          <button id="no-btn" data-bs-dismiss="modal">Không</button>
        </div>
      </div>
    </div>
  </div>
